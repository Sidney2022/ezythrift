...
SECRET_KEY = 'django-insecure-)e8)3*0w*eb)90b%7(ypt(#!pfbgjo)5d@xn&_zb@#3&do2g^i'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'core.context_processors.ProductCategories'
            ],
        },
    },
]

WSGI_APPLICATION = 'estores.wsgi.application'
